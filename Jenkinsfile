    ...
    stages {
        ...
        stage('Upload Docker Image to Harbor') {
            steps {
                script {
                    ...
                    docker tag practice-docker-aws-harboor:latest 43.205.217.143:8082/practice-docker-aws-harboor/practice-docker-aws-harboor:latest
                    docker push 43.205.217.143:8082/practice-docker-aws-harboor/practice-docker-aws-harboor:latest
        ...
        stage('Clean Up Local Docker Images') {
            steps {
                ...
                docker rmi 43.205.217.143:8082/practice-docker-aws-harboor/practice-docker-aws-harboor:latest || echo "Image not found or already deleted"
